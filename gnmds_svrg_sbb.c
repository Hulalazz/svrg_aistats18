...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	double relative_residual, eta_init, sum_residel, sum, epsilon, *eta, *duration, *X_int, *X_new, *X_snapshot_old, *X_snapshot_new, *train, *test, *avg_grad_old, *avg_grad_new, *stoch_grd, *snapshot_grd, *train_error, *test_error;
